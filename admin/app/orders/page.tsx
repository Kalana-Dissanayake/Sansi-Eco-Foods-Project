...
export default function OrdersPage() {
  ...
  return (
    <AdminLayout title="Orders" description="Track, manage, and update the status of all customer orders." pendingOrders={pendingCount} requiredPermission="orders_view">
